...
public class StpInterfaceImpl implements StpInterface {
    ...
    public List<String> getPermissionList(Object loginId, String loginType) {
        ...
        // 管理员权限，表示权限校验通过
        List<String> ADMIN_PERMISSIONS = spaceUserAuthManager.getUserPermissions(SpaceRoleEnum.ADMIN.getValue());
        // 获取上下文对象
    ...
    private SpaceUserAuthContext getAuthContextByRequest() {
        ...
        if (ObjUtil.isNotEmpty(id)) {
            ...
            String firstSegment = StrUtil.split(requestURI, '/').get(1); // 获取第一个路径段
            switch (firstSegment) {
                case "space":
